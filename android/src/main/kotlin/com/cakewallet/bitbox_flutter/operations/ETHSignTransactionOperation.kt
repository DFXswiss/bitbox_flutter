...
class ETHSignTransactionOperation(manager: BitboxManager) : UsbMethodCallOperation(manager.usbManager) {
    override fun onMethodCall(
        ...
        val gasPrice: String? = methodCall.argument("gasPrice")
        ...
        val res = Api.ethSignTransaction(
            chainID!!.toLong(),
            keypath,
            nonce!!.toLong(),
            gasPrice,
