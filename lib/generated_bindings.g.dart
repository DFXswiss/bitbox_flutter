...
class BitBoxFlutter {
  ...
  BitBoxFlutter(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  BitBoxFlutter.fromLookup(
      ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
          lookup)
      : _lookup = lookup;

  ffi.Pointer<ffi.Char> Count(
    int n,
    count_cb cb,
  ) {
    return _Count(
  ...
  late final _CountPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(ffi.Int, count_cb)>>('Count');
  late final _Count =
      _CountPtr.asFunction<ffi.Pointer<ffi.Char> Function(int, count_cb)>();
  ...
  late final _SetMessagePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char>)>>(
          'SetMessage');
  late final _SetMessage =
      _SetMessagePtr.asFunction<void Function(ffi.Pointer<ffi.Char>)>();

  int isBitBox02(
    ffi.Pointer<ffi.Char> product,
    int vendorID,
    int productID,
  ) {
    return _isBitBox02(
  ...
  late final _isBitBox02Ptr = _lookup<
      ffi.NativeFunction<
          GoUint8 Function(
              ffi.Pointer<ffi.Char>, GoUint16, GoUint16)>>('isBitBox02');
  late final _isBitBox02 = _isBitBox02Ptr
  ...
  late final _NewDevicePtr =
      _lookup<ffi.NativeFunction<GoUint8 Function()>>('NewDevice');
  late final _NewDevice = _NewDevicePtr.asFunction<int Function()>();

  int DeviceSupportsLTC() {
    return _DeviceSupportsLTC();
  }

  late final _DeviceSupportsLTCPtr =
      _lookup<ffi.NativeFunction<GoUint8 Function()>>('DeviceSupportsLTC');
  late final _DeviceSupportsLTC =
      _DeviceSupportsLTCPtr.asFunction<int Function()>();
}
...
typedef count_cbFunction = ffi.Void Function(ffi.Int);
typedef Dartcount_cbFunction = void Function(int);
typedef count_cb = ffi.Pointer<ffi.NativeFunction<count_cbFunction>>;
